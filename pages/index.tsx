...
import shipLap from "@/public/shiplapCannabis.png";
      ...
      <div>
        <div className="h-[95vh] w-full relative">
          <div className="text-white absolute inset-0 flex flex-col justify-center items-center text-center small:text-left small:justify-end small:items-start small:p-32">
            ...
            <h1 className=" flex font-extrabold underline text-4xl  text-center align-middle left-50% top-50%    mb-6 drop-shadow-md shadow-black">
              Summer time is here
            </h1>
        ...
        <h2 className="text-4xl font-bold text-center mt-20 mb-8"> Featured Products</h2>
