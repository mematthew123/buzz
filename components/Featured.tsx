...
// we are going to use the same code as the Hero component
// but we are going to change the props to match the new component
...
const Featured: React.FC<{ featuredData: FeaturedData }> = ({
  ...
  const positionClass =
    textPositionClasses[featuredData.textPosition] || "justify-center items-center";
